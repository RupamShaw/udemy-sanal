...
# wipro.udemy.com api
LOGOUT_URL = 'http://www.wipro.udemy.com/user/logout'
LOGIN_POPUP_URL = 'https://www.wipro.udemy.com/join/login-popup'
CHECK_COURSE_STATUS_URL = 'https://www.wipro.udemy.com/api-2.0/users/me/course-previews/?course={course_id}'
QUIZ_URL = 'https://www.wipro.udemy.com/api-2.0/quizzes/{quiz_id}/assessments?fields[assessment]=@all&page_size=250'
ATTACHED_FILE_URL = 'https://www.wipro.udemy.com/api-2.0/users/me/subscribed-courses/{course_id}/lectures/{lecture_id}/supplementary-assets/{asset_id}?fields[asset]=download_urls'
LOGIN_URL = 'https://www.wipro.udemy.com/join/login-popup/?displayType=ajax&display_type=popup&showSkipButton=1&returnUrlAfterLogin=https%3A%2F%2Fwww.wipro.udemy.com%2F&next=https%3A%2F%2Fwww.wipro.udemy.com%2F&locale=en_US'
GET_LECTURE_URL = 'https://www.wipro.udemy.com/api-2.0/users/me/subscribed-courses/{course_id}/lectures/{lecture_id}?fields[asset]=@min,download_urls,external_url,slide_urls&fields[course]=id,is_paid,url&fields[lecture]=@default,view_html,course&page_config=ct_v4'
COURSE_INFO_URL = 'https://www.wipro.udemy.com/api-2.0/courses/{course_id}/cached-subscriber-curriculum-items?fields[asset]=@min,title,filename,asset_type,external_url,length&fields[chapter]=@min,description,object_index,title,sort_order&fields[lecture]=@min,object_index,asset,supplementary_assets,sort_order,is_published,is_free&fields[quiz]=@min,object_index,title,sort_order,is_published&page_size=550'
COURSE_TITLE_URL = 'https://www.wipro.udemy.com/api-2.0/courses/{course_id}?fields[course]=title'
...
def get_course_id(course_link):
    ...
    if 'wipro.udemy.com/draft/' in course_link:
...
def save_link(link, dest, data_type):
    ...
    if 'Article' in data_type:
        return
    elif 'udemy-adaptive-streaming.wipro.udemy.com/' in link:
...
def main():
    ...
    try:
        if 'wipro.udemy.com/draft/' in link_args:
        ...
        logger.error('Please follow right url format.\n'
                     'Ex. https://www.wipro.udemy.com/COURSE-NAME, https://www.wipro.udemy.com/draft/COURSE-ID')
        sys.exit(1)
